...
```{r}
library(tidyverse)
bond.data <- read_csv("C:/Users/jl1n25/OneDrive - University of Southampton/Documents/GitHub/math6195-lab-3-jl1n25/data/jamesbond.csv")
bond.data
```
...
```{r}
bond.data |> ggplot(aes(x=Martinis, y=US_Adj, color=Year)) +
    geom_point() +
    scale_color_continuous()
```
